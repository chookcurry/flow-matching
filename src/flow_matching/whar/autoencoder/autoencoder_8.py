...
class Encoder(nn.Module):
    def __init__(self, in_c: int, latent_c: int):
        ...
        self.z_proj = nn.Conv2d(64, latent_c, kernel_size=3, padding=1)
...
class Decoder(nn.Module):
    def __init__(self, out_c: int, latent_c: int):
        ...
        self.conv1 = nn.Conv2d(latent_c, 64, kernel_size=3, padding=1)
        self.resblock1 = nn.Sequential(ResidualBlock(64, 8), ResidualBlock(64, 8))

        self.convT2 = nn.ConvTranspose2d(64, 32, kernel_size=4, stride=2, padding=1)
        self.resblock2 = nn.Sequential(ResidualBlock(32, 4), ResidualBlock(32, 4))
